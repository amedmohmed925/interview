        ...
        >
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold text-primary mb-4">
              {language === 'en' ? 'Backend Development Exam' : 'امتحان تطوير الخادم'}
            </h1>
            <p className="text-lg text-muted-foreground">
              {language === 'en' 
                ? 'Test your backend development knowledge with 50 comprehensive questions'
                : 'اختبر معرفتك في تطوير الخادم مع 50 سؤال شامل'
              }
            </p>
          </div>
